  ...
  return (
    <div className="bg-cyan-800 min-h-screen px-6">
       ...
       <div className="flex items-center gap-4 py-5 border-b-[1px] border-slate-300">
          ...
          <p className="text-md leading-[20px] font-light text-white">Dashboard</p>
       </div>
       <div className="pt-4 border-b-2 border-slate-300">
           <p className="text-sm font-bold leading-[16px] text-slate-400">INTERFACE</p>
           <div className="flex items-center justify-between gap-[10px] py-[15px] cursor-pointer">
                <div className="flex items-center gap-[10px]">
                    <FaRegSun className="text-white " />
                     
                    <Link className="text-md leading-[20px] font-light text-white">Pages</Link>
                </div>
        ...
        <div className="pt-4 border-b-2 border-slate-300">
           <p className="text-sm font-bold leading-[16px] text-slate-400">ADDONS</p>
           <div className="flex items-center justify-between gap-[10px] py-[15px] cursor-pointer">
                <div className="flex items-center gap-[10px]">
                    <FaStickyNote className="text-white " />
                     
                    <Link className="text-md leading-[20px] font-light text-white">Components</Link>
                </div>
                <FaChevronRight className="text-white"/>
            </div>
            <div className="flex items-center justify-between gap-[10px] py-[15px] cursor-pointer">
                <div className="flex items-center gap-[10px]">
                    ...
                    <Link className="text-md leading-[20px] font-light text-white">Utilities</Link>
                </div>
                <FaChevronRight className="text-white"/>
            </div>
            <div className="flex items-center justify-between gap-[10px] py-[15px] cursor-pointer">
                <div className="flex items-center gap-[10px]">
                    ...
                    <Link className="text-md leading-[20px] font-light text-white">Tables</Link>
                </div>
                <FaChevronRight className="text-white"/>
            </div>
        </div>
        ...
        <div>
            ...
            <div className='bg-cyan-500 mt-4 flex items-center justify-center flex-col py-[15px] px-[10px] gap-[15px] rounded-sm'>
