        ...
        <tbody>
          {users.map((user, index) => (
            <tr key={user._id} className={index % 2 === 0 ? 'bg-white' : 'bg-gray-50'}>
              <td className="p-3 text-sm text-gray-500 whitespace-nowrap">{index + 1}</td>
              <td className="p-3 text-sm text-gray-500 whitespace-nowrap">{user.username}</td>
              <td className="p-3 text-sm text-gray-500 whitespace-nowrap">{user.email}</td>
              <td className="p-3 text-sm text-gray-500 whitespace-nowrap">{user.age}</td>
